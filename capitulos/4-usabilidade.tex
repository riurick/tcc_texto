...
\subsubsection{Checklists}
	...
	Checklist é uma técnica de inspeção qu oferece uma maneira de abordagem rápida, fácil e de baixo custo para a avaliação de uma interface. Permite com que usuários que não são especialistas em ergonomia identificarem problemas menores e repetitivos.~\cite{cybis2010} %verificar
...
\subsubsection{Avaliação heurística}
	...
	Os avaliadores baseiam-se de heurísticas já conhecidas como as de Jakob Nielsen, Ben Shneiderman, Dominique Scapin e Christian Bastien, mas a que é mais utilizada são as 10 heurísticas de Nielsen ~\citeonline{nielsen1994}, que são qualidades de base para qualquer interface. São elas:
