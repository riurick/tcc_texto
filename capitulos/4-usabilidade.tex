...
\section{As áreas da Usabilidade}
	...
	Preece ~\cite{preece2007} define usabilidade como o fator que assegura que um produto ou serviço é fácil de usar, eficiente e agradável a partir do ponto de vista do usuário.
