...
\subsection {DCU e XP}
	...
	Foram encontrados alguns estudos que descrevem a integração do IHC com as práticas de Programação Extrema (XP). McInerney e Maurer mostraram que é possivel unir essas duas abordagens. Em seu artigo 
	...
	O papel de designer de interação não é reconhecido no núcleo eXtreme Programming (XP) da equipe e o XP não tem nenhum processo explícito para lidar com o design de interação.Em seu estudo (Jenniger, JAmes) relatam como os as equipes combinaram as atividades de design de interação com o XP. 
