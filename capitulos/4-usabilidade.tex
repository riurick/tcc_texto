...
\section{Processos de Usabilidade}
	...
	O termo modelo de ciclo de vida é utilizado para representar um modelo que capta um conjunto de atividades e a maneira como elas se relacionam ~\cite{preece2007}. Alguns autores como ~\citeonline{mayhew1999} e ~\citeonline{hix1993} propuseram modelos de processo baseados em ciclo de vidas bem definidos para as atividades de usabilidade. O modelo estrela e o de Engenharia de Usabilidade propostos pelos autores estão definidos no apêndice 1. 
...
% Inicio da Seção sobre métodos ágeis e o \emph{design} centrado no usuário
...
%	No próximo capítulo detalharemos como funciona um teste de usabilidade, os tipos existentes e as práticas identificadas pela comunidade de arquitetura da informação e áreas correlatas.
