...
%
O processo de desenvolvimento deste plugin ocorreu juntamente com uma transição da equipe de desenvolvimento, o que prejudicou o desenvolvimento de testes do mesmo.
%
...
\item \textbf{Scenario:} Upload a file with work assignment without 
    ...
    \textbf{And} I attach the file ``public/images/rails.png" to ``Uploaded data"
