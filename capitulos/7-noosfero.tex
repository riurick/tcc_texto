...
\begin{enumerate}
\item Quantidade de testes executados: 96
\item Quantidade de assertivas executadas: 111
\item Quantiadde de falhas obtidas: 0
...
\end{figure}
%
Na imagem acima existem dois graficos de cobertura de codigo, o primeiro definido como \textit{'total coverage'} representa a contagem realizada com as linhas em branco e os comentários do código, já p \textit{'code coverage'} representa a contagem realizada sem as linhas em branco e os comentários do código.
