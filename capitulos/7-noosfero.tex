...
%
Este plugin possui algumas funcionalidades específicas como possibilitar que os usuários envolvidos serjam norificados via email sobre a submissão de um certo trabalho. Para tal foi necessário subir um servidor de email para executar estas notificações, assim como criar uma página no portal para que o usuário pudesse submeter este trabalho.
%
Para validar o desenvolvimento desta funcionalidade foram desenvolvidos os seguintes testes: funcionais, unitário e de aceitação