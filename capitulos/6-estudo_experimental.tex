...
Secretária Executiva: responsável pelo financiamento dos projetos do ministério.

Diretor: responsável estratégico pelos projetos do ministério, seria o ``Product Owner'' do projeto.

Equipe SLTI: responsável pelo levantamento e validação dos requisitos do projeto.

Coordenadores: responsáveis estratégicos pela equipe de desenvolvimento do projeto (LAPPIS).

Equipe de desenvolvimento: responsável pelo desenvolvimento do portal do software público, que é dividida em duas equipes, uma responsável pelo Colab e outra pelo Noosfero, cada equipe com seu \textbf{coach}.
