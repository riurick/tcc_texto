...
\textbf{Checklists}
	Foi desenvolvido um checklist para auxiliar nas avaliações de heurísticas (econtra-se na seção \ref{checklist} do apendice \ref{apendice1}) seguindo as seguintes características:
	...
	\begin{itemize}
		...
		\item \textbf{Proteção contra erros:}deetecção de erros no momento da digitação. Isto pode evitar perturbações na planificação da tarefa.
...
\subsection{Testes com usuários}
	...
	\textbf{Objetivos}
		...
		O objetivo do teste com os usuários neste primeiro momento é ter um feedback das funcionalidades já desenvolvidas até o momento a fim de capturar alguns problemas de usabilidade. Não iremos tratar neste teste com o usuário a satisfação ao usar a ferramenta e sim verificar os possiveis problemas encotrados no uso por um usuário em específico.
	...
	Depois de especificado as tarefas que podem ser executados, foram escritos cenários que funciona como um script que o usuário possa seguir:
	...
	Com teste piloto, escolhemos um membro da equipe que não tinha participado do desenvolvimento da funcionalidade para que podemos testar os cenários e tarefas. A pessoa a ser testada também faz parte do grupo de usuários do sistema.
	
	\textbf{Observação}
	
		A observação de uso permite que o avaliador tenha uma visão dos problemas sendo vivenciados pelos usuários e também dos aspectos positivos experimentados durante o uso. É importante observar tudo o que o usuário está fazendo e realizar as anotações. Também pode ser gravado o aúdio ou a tela do usuário. Neste caso optamos por não gravar a tela do usuário.
...
No segundo ciclo de avaliações, utilizando o checklist \ref{checklists} para auxíliar as avaliações, observamos 3 problemas de criticidade baixa e 2 de criticidade média.
