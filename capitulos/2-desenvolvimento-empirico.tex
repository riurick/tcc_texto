...
%
O objetivo principal do XP é a excelência no desenvolvimento de software, visando baixo custo e poucos defeitos, de acordo com ~\citeonline{sato2007}. O XP conta com algumas práticas de desenvolvimento para dar suporte à busca pelos objetivos citados, essas práticas são: refatoração, integração contínua, testes automatizados, código coletivo e programação em pares.
