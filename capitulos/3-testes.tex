...
criar programas para testar cenários específicos por ~\citeonline{everett2007}. Testes de software serão abordados neste cápítulo, iniciando com uma visão geral de testes 
...
a utilização de uma linguagem ubíqua entre cliente e equipe de desenvolvimento de acordo com~\citeonline{bernardo2011}, subistituindo termos como assert, \textit{assert, test case, test suite} por termos 
...
como suporte para o desenvolvimento de software, por ~\citeonline{haring2011}. O BDD utiliza 
