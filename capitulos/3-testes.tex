...
criar programas para testar cenários específicos por ~\citeonline{everett2007}.
%
...
somente visíveis com um longo tempo de execução do sistema, erros que podem ser de cache, replicação, execução de serviços agendados ou vazamento de memória.
...
%TODO: alguns conceitos de testes têm referência e outros não.
%TODO: colocar as referências
%TODO: pontuar ao final da lista quais testes iremos tratar neste trabalho.
...
livro \textit{Test-Driven Development: By Example}~\citeonline{beck2002}, como
...
dos objetos.
%TODO: confuso - "como ponto de partida o compartamento dos objetos"?
...
sobre as interações sobre pessoas e sistemas, ou entre os objetos, do que sobre a 
estrutura do objeto~\cite{chelimsky2010}.
%TODO: em que contexto você está falando de objetos?
...
\end{enumerate}
%TODO: parte da lista está referenciada e outra parte não...
...
%TODO: com não explicaram métodos ágeis de forma mais didática e prática, aqui o leitor não sabe o que é um histório de usuário...
...
%TODO: até fez uma conclusão, mas não fez o link com o que vem pela frente.
