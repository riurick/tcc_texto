...
criar programas para testar cenários específicos~\citeonline{everett2007}. Testes de software 
...
dos componentes de um sistema.~\citeonline{molinari2003}
...
módulo funciona como foi especificado~\citeonline{martin2005}.
%
Testes de aceitação devem utilizar linguagem proxima da natural para evitar 
problemas de interpretação e de ambiguidades~\citeonline{cunningham2005}.
...
precisam de otimização para diminuir o tempo de resposta  para o usuário~\citeonline{liu2009}.
...
sistema~\citeonline{avritze1994}.
...
confidenciabilidade, integridade, autenticação, autorização, privacidade~\citeonline{whittaker2006}.
...
livro \textit{Test-Driven Development: By Example}~\citeonline{beck2002}. Os passos estão 
...
teste passar e fazer sempre apenas uma refatoração por vez~\citeonline{beck2002}. Assim o 
...
e testes, o que favorece e facilita a criação de sistemas com alta testabilidade~\citeonline{bernardo2011}. 
...
a utilização de uma linguagem ubíqua entre cliente e equipe de desenvolvimento~\citeonline{bernardo2011}, subistituindo termos como assert, \textit{assert, test case, test suite} por termos 
...
como suporte para o desenvolvimento de software~\citeonline{haring2011}. O BDD utiliza 
...
qualquer nível de granularidade ~\citeonline{chelimsky2010}. 
\end{enumerate}
%
