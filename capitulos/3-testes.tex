...
%TO DO: RELACIONAR TESTES DE ACEITAÇÃO COM TESTES DE USABILDIADE
...
Será abordado neste trabalho o desenvolvimento de testes de aceitação para verificar uma possível relação com a usabilidade dos sistemas estudados. Também utilizaremos testes funcionais e testes de unidade para verificar essa relação.
