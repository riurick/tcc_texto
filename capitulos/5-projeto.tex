...
\begin{enumerate}
  \item Qual a quantidade de testes de aceitação executados por ciclo?
    \subitem{\textbf{Fonte:} suíte de testes do Cucumber.}
    \subitem{\textbf{Métrica:} Quantidade de testes de aceitação executados por ciclo.}
  \item Quantos problemas de usabilidade de criticidade baixa são encontrados por ciclo?
    \subitem{\textbf{Fonte:} Planilha de avaliação.}
    \subitem{\textbf{Métrica:} Quantidade de problemas de usabilidade de criticidade baixa por ciclo.}
  \item Quantos problemas de usabilidade de criticidade média são encontrados por ciclo?
    \subitem{\textbf{Fonte:} Planilha de avaliação.}
    \subitem{\textbf{Métrica:} Quantidade de problemas de usabilidade de criticidade média por ciclo.}
  \item Quantos problemas de usabilidade de criticidade alta são encontrados por ciclo?
    \subitem{\textbf{Fonte:} Planilha de avaliação.}
    \subitem{\textbf{Métrica:} Quantidade de problemas de usabilidade de criticidade alta por ciclo.}
\end{enumerate}
...
Quanto aos testes de aceitação dos cenários avaliados tivemos os resultados de medição do primeiro ao último ciclo de avaliações na figura \ref{teste_usuario} para a história ``Cadastro de Usuário'':

\begin{figure}[h!]
      \centering
      \includegraphics[keepaspectratio=true,scale=0.5]
          {figuras/teste_usuario.eps}
      \caption{Testes de ``Cadastro de Usuário''}
      \label{teste_usuario}
\end{figure}

Para os testes da história de ``Cadastro de Instituição'' tesmos a figura \ref{teste_instituicao}:

\begin{figure}[h!]
      \centering
      \includegraphics[keepaspectratio=true,scale=0.5]
          {figuras/teste_instituicao.eps}
      \caption{Testes de ``Cadastro de Instituição''}
      \label{teste_instituicao}
\end{figure}

\newpage
Para os testes da história de ``Cadastro de Software'' temos a figura \ref{teste_software}:

\begin{figure}[h!]
      \centering
      \includegraphics[keepaspectratio=true,scale=0.5]
          {figuras/teste_software.eps}
      \caption{Testes de ``Cadastro de Software''}
      \label{teste_software}
\end{figure}
