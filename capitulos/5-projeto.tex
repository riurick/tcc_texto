...
A partir dos protótipos e dos cenários desenvolvidos durante as \textit{release} 1 e 2, analisamos alguns problemas de usabilidade com base nas heurísticas de Nielsen, essa análise foi feita durante a sprint 18. A tabela \ref{table_1a} descreve os problemas encontrados nas primeiras análises.
