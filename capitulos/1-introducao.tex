...
% terceiro capítulo aborda conceitualmente as técnicas de testes automatizados que geralmente são utilizadas no processo empírico, além dos tipos de testes que podem ser aplicados. Nesta seção são destacados o TDD (\textit{Test Driven Development}) e o BDD (\textit{Behavior Driven Development}).
