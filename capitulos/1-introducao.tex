...
%TODO: referência o trabalho da Ana Paula Santos.
...
%TODO: faltou referência aqui... possivelmente também o texto da Ana Paula  
%
...
%TODO: o que é ser responsivo? Sejam mais didáticos com o Leitor
%TODO: quero uma nota de rodapé para a notícia sobre esta funcionalidade no Joomla
...
%TODO: descrever sigla CMS
%TODO: quais melhorias?
...
%TODO: Quais melhorias?
%TODO: falou do Joomla, falou do Wordpress... e o Noosfero?
...
%TODO: não fizeram um link entre uma possível relação entre testes e usabilidade

Alguns estudos relatam a possibilidade de inserir as práticas de usabilidade em contextos de projetos ágeis
...
%TODO: não falaram da questão dos testes automatizados: quais os problemas relacionados com os testes
...
%TODO: descreva o que é TDD e BDD
...
%TODO: acho que não faremos isso

%\item Evoluir o processo de desenvolvimento de software empírico a partir de um estudo de caso específico;
%TODO: não vamos evoluir processo...

\end{enumerate}

\section{Questões de pesquisa}

%TODO:comentem algo sobre as questões de pesquisa
...
%TODO: mais uma vez a parte de teste não foi contemplada
...
%TODO: isso deve ser introduzido e um pouco explicado na seção de metodologias
