...
Atualmente, algumas comunidades de software livre vêm se atentando as questões de usabilidade como forma de se manter no mercado. Um dos casos que conhecemos foi do Joomla que é um CMS (Content Manager System) ou em português, sistema de gerenciamento de conteúdo, que nessas últimas versões investiram em questões de usabilidade, sendo o primeiro CMS a ser 100 por cento adaptado a dispositivos móveis tanto no conteúdo como na área administrativa. \footnote{\url{http://joomla.org/3/pt_br}}
