...
Atualmente, algumas comunidades de software livre vêm se atentando às questões de usabilidade como forma de se manter no mercado. 
%
...
\begin{enumerate}
\item Verificar aplicação das práticas do BDD no processo de desenvolvimento de software livre;
...
%
O terceiro capítulo aborda conceitualmente as técnicas de testes automatizados que geralmente são utilizadas no processo empírico, além dos tipos de testes que podem ser aplicados. Nesta seção destaca-se o TDD o BDD (Behavior Driven Development).
%
