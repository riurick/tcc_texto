...
EDITAVEIS_SOURCES = informacoes.tex errata.tex dedicatoria.tex \
					...
					apendices.tex \
					apendices2.tex anexos.tex

EDITAVEIS_FILES = $(addprefix $(EDITAVEIS_DIR)/, $(EDITAVEIS_SOURCES))

CHAPTERS_DIR = capitulos
CHAPTERS_SOURCES = 1-introducao.tex 2-desenvolvimento-empirico.tex 3-testes.tex \
					4-usabilidade.tex 5-projeto.tex 6-estudo_experimental.tex 8-consideracoes-finais.tex
